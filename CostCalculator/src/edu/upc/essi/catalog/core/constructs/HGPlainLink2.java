 ...
 */
public class HGPlainLink2 implements HGLink, Iterable<HGHandle> {
	/**
	 * An array of <code>HGHandle</code>s representing the target set of this link.
	 * The array should never be <code>null</code>. An empty target set should be
	 * represented by an 0 length array.
	 */
	 ...
	 * </p>
	 * 
	 * @param outgoingSet A non-null array of valid <code>HGHandle</code>s of length
	 *                    > 0.
	 */
	public HGPlainLink2(HGHandle... outgoingSet) {
		if (outgoingSet == null)
	...
	/**
	 * <p>
	 * Return the <code>i</code>th target of this link.
	 * </p>
	 * 
	...
	public void setNewOutgoing(ArrayList<HGHandle> newTargets) {
		HGHandle[] newOutgoing = newTargets.toArray(new HGHandle[newTargets.size()]);
		outgoingSet = newOutgoing;
	}
	...
	public Iterator<HGHandle> iterator() {
		return new Iterator<HGHandle>() {
			...
			public boolean hasNext() {
				return curr < outgoingSet.length;
			}

			public HGHandle next() {
				return outgoingSet[curr++];
			}
		};
	}
