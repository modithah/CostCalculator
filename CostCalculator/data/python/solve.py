...
def solve_me():
	...
	collection_1_size = 990.5
	collection_1_count = 2500000.0
	collection_1_freq = 0.11764705882352941
	#docs per block
	...
	collection_1_index_1_mult = 1.0
	collection_1_index_1_distinct = 2500000.0
	collection_1_index_1_rep = collection_1_index_1_mult * collection_1_count / collection_1_index_1_distinct
	collection_1_index_1_freq = 0.11764705882352941

	# Index collection_1_index_1 leaf and internal blocks
	collection_1_index_1_leaf = collection_1_count / primary_idx
	collection_1_index_1_internal = collection_1_index_1_leaf * iinternal / (ifillint * iBint - imeta)

	# Collection collection_2
	collection_2_size = 6476.0
	collection_2_count = 100000.0
	collection_2_freq = 0.11764705882352941
	#docs per block
	...
	collection_3_size = 663.5
	collection_3_count = 4000000.0
	collection_3_freq = 0.4117647058823529
	#docs per block
	...
	collection_3_index_1_mult = 3.5
	collection_3_index_1_distinct = 1.4E7
	collection_3_index_1_rep = collection_3_index_1_mult * collection_3_count / collection_3_index_1_distinct
	collection_3_index_1_freq = 0.11764705882352941

	# Index collection_3_index_1 leaf and internal blocks
	collection_3_index_1_leaf = collection_3_index_1_mult * collection_3_count / secondary_idx
...
1.1 * (collection_3_index_1_sat + collection_3_index_1_internal * iBint)  == M,
	...
	collection_1_prob == 
	1 - (1 - (((collection_1_index_1_SF)
)/1 )) ** collection_1_docs ,
	collection_2_prob == 
	1 - (1 - (((collection_2_index_1_SF)
)/1 )) ** collection_2_docs ,
	collection_3_prob == 
	1 - (1 - (((( 1 - (1 - collection_3_index_1_SF) ** collection_3_index_1_mult))
)/1 )) ** collection_3_docs ,
	collection_1_index_1_prob == 1 - ( 1 - collection_1_index_1_SF) ** primary_idx ,
	collection_2_index_1_prob == 1 - ( 1 - collection_2_index_1_SF) ** primary_idx ,
	collection_3_index_1_prob == 1 - ( 1 - collection_3_index_1_SF) ** (secondary_idx /collection_3_index_1_rep) ,
	...
	collection_1_index_1_exp == collection_1_count * ( 1 - ((collection_1_count- 1) /collection_1_count) ** collection_1_index_1_req),
	collection_2_index_1_exp == collection_2_count * ( 1 - ((collection_2_count- 1) /collection_2_count) ** collection_2_index_1_req),
	collection_3_index_1_exp == collection_3_index_1_distinct * ( 1 - ((collection_3_index_1_distinct- 1) /collection_3_index_1_distinct) ** collection_3_index_1_req),
	]) 
	m.options.SOLVER = 1
...
1.1 * (collection_3_index_1_evict*iB + collection_3_index_1_internal * iBint)  == M,
	...
	collection_1_E / (collection_1_E+collection_2_E+collection_3_E+collection_1_index_1_E+collection_2_index_1_E+collection_3_index_1_E)==
	collection_1_freq * (1- collection_1_evict / collection_1_leaf) / (collection_1_freq * (1- collection_1_evict / collection_1_leaf)+collection_2_freq * (1- collection_2_evict / collection_2_leaf)+collection_3_freq * (1- collection_3_evict / collection_3_leaf)+collection_1_index_1_freq * (1- collection_1_index_1_evict / collection_1_index_1_leaf)+collection_2_index_1_freq * (1- collection_2_index_1_evict / collection_2_index_1_leaf)+collection_3_index_1_freq * (1- collection_3_index_1_evict / collection_3_index_1_leaf)),
	collection_2_E / (collection_1_E+collection_2_E+collection_3_E+collection_1_index_1_E+collection_2_index_1_E+collection_3_index_1_E)==
	collection_2_freq * (1- collection_2_evict / collection_2_leaf) / (collection_1_freq * (1- collection_1_evict / collection_1_leaf)+collection_2_freq * (1- collection_2_evict / collection_2_leaf)+collection_3_freq * (1- collection_3_evict / collection_3_leaf)+collection_1_index_1_freq * (1- collection_1_index_1_evict / collection_1_index_1_leaf)+collection_2_index_1_freq * (1- collection_2_index_1_evict / collection_2_index_1_leaf)+collection_3_index_1_freq * (1- collection_3_index_1_evict / collection_3_index_1_leaf)),
	collection_3_E / (collection_1_E+collection_2_E+collection_3_E+collection_1_index_1_E+collection_2_index_1_E+collection_3_index_1_E)==
	collection_3_freq * (1- collection_3_evict / collection_3_leaf) / (collection_1_freq * (1- collection_1_evict / collection_1_leaf)+collection_2_freq * (1- collection_2_evict / collection_2_leaf)+collection_3_freq * (1- collection_3_evict / collection_3_leaf)+collection_1_index_1_freq * (1- collection_1_index_1_evict / collection_1_index_1_leaf)+collection_2_index_1_freq * (1- collection_2_index_1_evict / collection_2_index_1_leaf)+collection_3_index_1_freq * (1- collection_3_index_1_evict / collection_3_index_1_leaf)),
	collection_1_index_1_E / (collection_1_E+collection_2_E+collection_3_E+collection_1_index_1_E+collection_2_index_1_E+collection_3_index_1_E)==
	...
	collection_2_index_1_E / (collection_1_E+collection_2_E+collection_3_E+collection_1_index_1_E+collection_2_index_1_E+collection_3_index_1_E)==
	...
	collection_3_index_1_E / (collection_1_E+collection_2_E+collection_3_E+collection_1_index_1_E+collection_2_index_1_E+collection_3_index_1_E)==
